...
/**
 * The pictures, which are the only data here too large for localStorage (ADR 5).
 *
 * The database is opened on first use, so a hunt without photos never touches it.
 */
