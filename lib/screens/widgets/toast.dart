...
class Toasts extends ChangeNotifier {
  ...
  void _setButton(Object owner, {required bool present}) {
...
class _MainActionButtonState extends State<MainActionButton> {
  ...
  void didChangeDependencies() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Toasts.instance._setButton(this, present: inFront && mounted);
    });
  }

  @override
  void dispose() {
    Toasts.instance._setButton(this, present: false);
    super.dispose();
  }
